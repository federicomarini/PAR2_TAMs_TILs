...
All sequencing datasets generated for this study have been deposited on the [] database under accession code [], where readers can retrieve raw scRNA-seq data (from the bam files output by the Cellranger software), as well as count matrices (stored in the sparse matrix format).  
...
Deployed instances for the datasets generated in this work are available at [] [], respectively.
